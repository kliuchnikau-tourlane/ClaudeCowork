# Process Tailoring — Project Portfolio

How corporate and Tech department processes need to evolve as LLM tooling adoption grows.
...
Each subfolder can hold briefs, ADRs, research notes, and references for that initiative. The living tracker is at `ProcessTailoring_Tracker.md` in this folder.
